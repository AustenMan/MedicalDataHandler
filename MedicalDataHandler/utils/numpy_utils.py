...
def create_HU_to_RED_map():
    ...
    """
    example_cal_curve_hu_values = np.array(
        [
    ...
    example_cal_curve_red_values = np.array(
        [
    ...
    return interp1d(example_cal_curve_hu_values, example_cal_curve_red_values, kind="linear", bounds_error=False, fill_value="extrapolate")
