<p align="center">
  <img src="MedicalDataHandler/assets/MDH_Logo_Credit_DALL-E.png" alt="MedicalDataHandler_Logo" width="200">
</p>
...
<p align="center">
  <img src="MedicalDataHandler/images/10_ThreeViews.png" alt="Three Views">
  <br>
...
- ✅ **Enable specialized post-processing**, including:  
   - **CT HU-to-RED conversion** (Hounsfield Units → Relative Electron Density)  
     - **Sample values are provided for convenience**, however, it is **STRONGLY ADVISED** to **update** these values in the configuration files to **align with your institutional data** (See: https://github.com/AustenMan/MedicalDataHandler/blob/main/MedicalDataHandler/configs/ , ct_HU_map_vals.json and ct_RED_map_vals.json) 
...
- ✔ **Automated DICOM file identification** in a user-specified directory.  
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/2_DicomSearch.png" alt="DICOM Search">
    <br>
...
- ✔ **Automated DICOM file linking** to group related data.  
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/3_DicomLink.png" alt="DICOM Linking">
    <br>
...
- ✔ **Patient Data Table** for structured display of accessible patient data.  
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/4_DataTablePatients.png" alt="Data Table Patients">
    <br>
...
- ✔ **Patient Object Inspection** for in-depth data analysis.  
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/5_PatientInspect.png" alt="Inspection Patient Object">
    <br>
...
- ✔ **DICOM metadata inspection** with collapsible trees and filters.
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/6_DicomInspect.png" alt="Inspection DICOM Metadata">
    <br>
...
- ✔ **Frame Of Reference UID Data Table** for deeper organization of patient-specific data.  
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/7_DataTableFrames.png" alt="Data Table FORUID">
    <br>
...
- ✅ **Data visualization** by converting DICOM data to [SimpleITK](https://github.com/SimpleITK/SimpleITK) Images and [NumPy](https://github.com/numpy/numpy) arrays.  
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/8_DataTableLoad.png" alt="Data Table Load">
    <br>
...
- ✅ **Customizable display toggles** for flexible visualization of any loaded images, dose distributions, and/or structures.  
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/9_LoadedHomePage.png" alt="DICOM Data Loaded">
    <br>
...
- ✅ **Inspection of loaded data** to add or edit certain fields, such as machine name.
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/11_SitkInspect.png" alt="Inspection Loaded Data">
    <br>
...
- ✔ **Supports both partial (single-item) and batch data saving**.  
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/13_Save.png" alt="Save">
    <br>
...
- ✔ **Settings window** with options such as:  
  ...
  <p align="center">
    <img src="MedicalDataHandler/images/12_Settings.png" alt="Settings">
    <br>
...
- ✔ **Basic image processing tools (e.g., filtering).**  
