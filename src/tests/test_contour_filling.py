"""
Test ROI contour-to-mask conversion and complete DICOM-to-mask pipeline including coordinate transformations.
"""
...
class TestContourFilling:
    """Test ROI contour-to-mask conversion pipeline."""
    ...
    def test_oblique_orientation_handling(self):
        ...
        origin = [5.0, 5.0, 10.0]
        spacing = [2.0, 2.0, 4.0]
        # 45 degree Z-axis rotation direction cosines
